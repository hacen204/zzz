...
set_num_threads(12)  # Limite à 12 threads
...
def calculate_daily_weights_and_pnl(df_strat: pd.DataFrame, scaling: int = 10) -> pd.DataFrame:
    ...
    coupon_list = ['0.025', '0.030', '0.035', '0.040', '0.045', 
...
def main():
    ...
    try:
        # Configure paths
        data_dir = Path("/Users/samybenaoun/Documents/Data_rates")
        input_file = data_dir / "mbs_global_data_cleaned_final_2010_2024.csv"
        oas_file = data_dir / "oas_result_global_2010_2024csv"
        ...
        df_results = calculate_oas_pivoted_table(df_gross_data, oas_file)
